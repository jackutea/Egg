...
namespace TiedanSouls.World.Entities {
    ...
    public class RoleInputComponent {
        ...
        bool hasInput_Skillor_Jump;
        public bool HasInput_JumpDown => hasInput_Skillor_Jump;
        public void SetInput_Locomotion_Jump(bool value) => this.hasInput_Skillor_Jump = value;

        bool hasInput_Skillor_Melee;
        public bool HasInput_Melee => hasInput_Skillor_Melee;
        public void SetInput_Skillor__Melee(bool value) => this.hasInput_Skillor_Melee = value;

        bool hasInput_Skillor_SpecMelee;
        public bool HasInput_SpecMelee => hasInput_Skillor_SpecMelee;
        public void SetInput_Skillor_SpecMelee(bool value) => this.hasInput_Skillor_SpecMelee = value;

        bool hasInpout_BoomMelee;
        public bool HasInpout_BoomMelee => hasInpout_BoomMelee;
        public void SetInput_Skillor_BoomMelee(bool value) => this.hasInpout_BoomMelee = value;

        bool hasInput_Skillor_Infinity;
        public bool HasInput_Infinity => hasInput_Skillor_Infinity;
        public void SetInput_Skillor_Infinity(bool value) => this.hasInput_Skillor_Infinity = value;

        bool hasInput_Skillor_Dash;
        public bool HasInput_Dash => hasInput_Skillor_Dash;
