...
namespace TiedanSouls.EditorTool {
    ...
    [CustomEditor(typeof(RoleEffectorEditorGO))]
    public class RoleEffectorEditorInspector : Editor {

        RoleEffectorEditorGO editorGo;
        ...
        void OnEnable() {
            ...
            editorGo = target as RoleEffectorEditorGO;
